...
//  *
//  *                 ,----------------------------------.                                               ,----------------------------------.
//  *                 |      |      |      |Print |      |                                               | Mute |VolDn |VolUp | F15  |      |      
//  *                 |      |      |      |Screen|      |                                               |      |      |      |      |      |      
//  *                 |------+------+------+------+------|                                               |------+------+------+------+------|
//  *                 |  F1  |  F2  |  F3  |  F4  |  F5  |                                               |  F6  |  F7  |  F8  |  F9  |  F10 |
//  *                 |  GUI | LALT | LCTL | LSFT |      |                                               |      | LSFT | LCTL |  ALT |  GUI |
//  *                 |------+------+------+------+------|                                               |------+------+------+------+------|
//  *                 |      | F10  | F11  | F12  |      |                                               | Play |M Prev|M Next| F13  | F14  |
//  *                 |      |      |      |      |      |                                               |      |      |      |      |      |
//  *                 `---------------------------+------+------.                                 ,------+------+---------------------------'
//  *                                      |******|      |      |                                 |      |      |
//  *                                      |******|      |      |                                 |      |      |
...
//  */
     [_FUN] = LAYOUT(
                _______, _______, _______, KC_PSCR, _______,                                        KC_MUTE, KC_VOLD, KC_VOLU, KC_F15, _______,
                GUI_F1 , ALT_F2 , CTL_F3 , SFT_F4 , KC_F5  ,                                        KC_F6  , SFT_F7 , CTL_F8 , ALT_F9 , GUI_F10,
                _______, KC_F10	, KC_F11 , KC_F12 , _______,                                        KC_MPLY, KC_MPRV, KC_MNXT, KC_F13 , KC_F14,
